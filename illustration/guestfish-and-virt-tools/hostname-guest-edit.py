#!/usr/bin/python
#########################################################
## PURPROSE: To replace hostname in a file. Please read the comments carefully.
...
# NOTE:the libguestfs handle should be launched *after* adding the drive(s), and *before* any other
# commands are run. This launches the qemu subprocess.
g.launch ()

# Set the trace flag so that we can see each libguestfs call
g.set_trace (1)

# To access the filesystem in the disk image, mount it. (NOTE: both block-devices and LVMs
# are detected)
...
# This will write any data buffered in memory to disk (aka: write all flush through to the
# disk image. NOTE: This is very important to do. 
g.sync ()
